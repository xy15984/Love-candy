...
function disagree(len){
	var msgArray = ["听话","家务全包","工资上交","我妈会游泳","有车","有房","有颗爱你的心","月入百万","饭我做","孩子我带","你就从了吧","我是不会让你跑的","快点同意"];
	if(len==msgArray.length){
		len = 0;
	}
	layer.msg(msgArray[len], {
        time: 20000, //20s后自动关闭
        btn: ['好', '不好'],
        btnAlign:'c',
        offset: ['300px', '450px'],
